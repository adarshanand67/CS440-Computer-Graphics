...
void drawScene(void)
{
    ...
    glRectf(5.0, 5.0, 80, 80); // Rectangle with top left corner at (0,0) and bottom right corner at (75,75)

    glColor3f(1.0, 0.0, 0.0);
    glRectf(10.0, 10.0, 75, 75); // Rectangle with top left corner at (0,0) and bottom right corner at (75,75)
